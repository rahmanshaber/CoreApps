...
QString UDisks2Block::toStringToSeperate(int i) {
    switch (i) {
    case 1:
        return name;
        break;
    case 2:
        return Utilities::formatSize(size);// Function from utilities.cpp
        break;
    case 3:
        return dev;
        break;
...
//Properties collect
QString UDisks2Drive::toStringToSeperate(int i) {
    switch (i) {
    case 1:
        return name;
        break;
    case 2:
        return Utilities::formatSize(static_cast<qint64>(size));
        break;
    case 3:
        return vendor;
        break;
